...
state.label=/* ignoreName */ /* eat */!1/* skipSlots */ /* skipSlots */;if(0==state.commandMode)state.commandMode=1;else if(0>state.commandMode||2==state.commandMode)state.commandMode=0}else if("."!=ch&&0<state.commandMode){if(":"==ch)state.commandMode=-1;// SIS - Command post-conditional
